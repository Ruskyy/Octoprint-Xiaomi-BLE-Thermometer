...
plugin_identifier = "XiaomiBLEThermo"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "XiaomiBLEThermo"
...
# module
plugin_description = "An integration plugin for Xiaomi BLE Thermometers"

# The plugin's author. Can be overwritten within OctoPrint's internal data via __plugin_author__ in the plugin module
plugin_author = "Rusky"

# The plugin's author's mail address.
plugin_author_email = "informatic5.0@gmail.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/Ruskyy/Octoprint-Xiaomi-BLE-Thermometer"
